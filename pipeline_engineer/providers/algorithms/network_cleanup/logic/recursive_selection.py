...
def recursive_selection(edges,forwards):
    ...
    while True:
        ...
        exp = f' "numeric_id" IN ({selected_lines_string}) AND "vertex_pos" = {direction}'
        ...
        processing.run("qgis:selectbyexpression", 
                                    {'INPUT':specific_vertices,
                                     'EXPRESSION':f'"numeric_id" NOT IN ({selected_lines_string}) AND "vertex_pos" = {other_direction}',
                                     'METHOD':3})
