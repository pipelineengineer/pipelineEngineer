...
def beggs_brill_method(gas_flow_rate,liquid_flow_rate,
    ...
    #print('Liquid Holdup: ',liquid_holdup)
    #print('Reynolds: ',re_ns)
    #print('Acceleration Correction Factor: ',accel_correction_factor)
    #print("mix density: ",(mixture_density * 0.06242796))
    #print("mix velocity: ",(v_m* 3.281) )
    #print("velocity, gas superficial: ",(v_sg* 3.281))
    #print("pressure: ",pres*14.504)
    #print('Pressure Drop (Elevation): ',pres_drop_elev,'bar')
    #print('Friction Factor: ',f_ns)
