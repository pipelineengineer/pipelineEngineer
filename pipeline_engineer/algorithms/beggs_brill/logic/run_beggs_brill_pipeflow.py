...
from ...pandapipes_for_qgis.logic.running_pipeflow import *
from ...fluids.logic.fluids import *
from .correct_directionality import *

def run_beggs_brill_pipeflow(layers,pipeflow_fluid,args,
                             liquid_phase,gas_phase,
                             gas_fraction,surf_tens,
    ...
    gas_density = get_fluid_parameter(parameter='density',chosen_fluid=gas_phase,temperature=fluid_temp,pressure=fluid_pres)
    ...
    line_df, junction_df,master_results_df = pressures_through_a_network(line_data_df, line_xyz_df,grids_df,
