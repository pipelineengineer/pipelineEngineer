...
def pres_drop_over_line(line_data_df, line_xyz_df,
    ...
    for index, row in line_mesh_df.iterrows():
        ...
        #bb_df_entry = beggs_brill(
        #                          length=length,elev=elevation,diameter=internal_diameter,roughness=line_roughness
        #                          rho_l=liquid_density,mu_l=liquid_viscosity,sigma=surf_tens,
        #                          rho_g=gas_density,pres=pres, q_m=vol_flow_rate, gas_frac=gas_fraction
        #                         )
