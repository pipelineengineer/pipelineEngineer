...
<qgis styleCategories="Labeling" version="3.44.2-Solothurn" labelsEnabled="1">
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style legendString="Aa" fontItalic="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" tabStopDistance="80" fontWordSpacing="0" fontFamily="Open Sans" textColor="116,116,116,255,hsv:0,0,0.4541542687113756,1" previewBkgrdColor="255,255,255,255,rgb:1,1,1,1" multilineHeightUnit="Percentage" forcedBold="0" fontSize="10" stretchFactor="100" allowHtml="0" fieldName="CONCAT(&quot;name&quot;,'\nActive Power: ', ROUND(&quot;p_from_mw&quot;*100,2) ,' kW','\n Reactive Power: ',ROUND(&quot;q_from_mvar&quot;,2),' MVar\nCurrent: ',ROUND(&quot;i_from_ka&quot;,2),' kA\nVoltage Magnitude: ',ROUND(&quot;vm_from_pu&quot;,2),' per unit\nVoltage Angle: ',ROUND(&quot;va_from_degree&quot;,2),' Degrees\nLoading Percent: ',ROUND(&quot;loading_percent&quot;,2),'%')" fontUnderline="0" fontKerning="1" blendMode="0" multilineHeight="1" textOpacity="1" isExpression="1" useSubstitutions="0" fontStrikeout="0" textOrientation="horizontal" tabStopDistanceMapUnitScale="3x:0,0,0,0,0,0" fontSizeUnit="Point" tabStopDistanceUnit="Point" fontLetterSpacing="0" capitalization="0" namedStyle="Bold" fontWeight="75" forcedItalic="0">
        <families/>
      ...
      <placement centroidInside="0" polygonPlacementFlags="2" rotationUnit="AngleDegrees" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" repeatDistanceUnits="MM" offsetType="0" prioritization="PreferCloser" priority="5" overrunDistanceUnit="MM" maximumDistance="0" quadOffset="4" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" lineAnchorTextPoint="FollowPlacement" xOffset="0" geometryGenerator="" fitInPolygonOnly="0" placementFlags="10" placement="2" geometryGeneratorType="PointGeometry" lineAnchorPercent="0.5" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorEnabled="0" overlapHandling="PreventOverlap" centroidWhole="0" yOffset="0" allowDegraded="0" overrunDistance="0" dist="0" maxCurvedCharAngleOut="-25" layerType="LineGeometry" lineAnchorType="0" distMapUnitScale="3x:0,0,0,0,0,0" maximumDistanceUnit="MM" repeatDistance="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorClipping="0" rotationAngle="0" maximumDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MM" distUnits="MM" preserveRotation="1"/>
